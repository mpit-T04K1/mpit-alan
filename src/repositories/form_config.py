...
class FormConfigRepository:
    ...
    async def get_active_by_types(
        db: AsyncSession, business_type: str, form_type: str
    ) -> Optional[FormConfig]:
        """
    ...
    async def get_by_business_type(
        db: AsyncSession, business_type: str, active_only: bool = True
    ) -> List[FormConfig]:
        """
    ...
    @staticmethod
    async def update(
        db: AsyncSession, form_config_id: int, form_config_update: FormConfigUpdate
    ) -> Optional[FormConfig]:
        """
