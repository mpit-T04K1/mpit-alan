...
class LocationUpdate(BaseModel):
    ...
    name: Optional[str] = Field(
        None, min_length=1, max_length=255, description="Название локации"
    )
    address: Optional[str] = Field(
        None, min_length=5, max_length=255, description="Адрес локации"
    )
...
class CompanyBase(BaseModel):
    ...
    business_type: str = Field(
        ..., min_length=1, max_length=50, description="Тип бизнеса"
    )
    ...
    contact_phone: str = Field(
        ..., min_length=5, max_length=20, description="Контактный телефон"
    )
    website: Optional[str] = Field(None, description="Веб-сайт компании")
    social_links: Optional[Union[Dict[str, str], str]] = Field(
        None, description="Социальные сети"
    )
...
class CompanyCreate(CompanyBase):
    ...
    company_metadata: Optional[Dict[str, Any]] = Field(
        None, description="Метаданные компании"
    )
...
class CompanyUpdate(BaseModel):
    ...
    business_type: Optional[str] = Field(
        None, min_length=1, max_length=50, description="Тип бизнеса"
    )
    description: Optional[str] = Field(None, description="Описание компании")
    contact_name: Optional[str] = Field(None, description="Контактное лицо")
    contact_email: Optional[EmailStr] = Field(None, description="Контактный email")
    contact_phone: Optional[str] = Field(
        None, min_length=5, max_length=20, description="Контактный телефон"
    )
    website: Optional[str] = Field(None, description="Веб-сайт компании")
    social_links: Optional[Union[Dict[str, str], str]] = Field(
        None, description="Социальные сети"
...
class CompanyModerationUpdate(BaseModel):
    ...
    moderation_comment: Optional[str] = Field(
