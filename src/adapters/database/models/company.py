...
class Company(Base):
    ...
    moderated_by_id = Column(
        "moderated_by", Integer, ForeignKey("users.id"), nullable=True
    )
    ...
    working_hours = relationship(
        "WorkingHours", back_populates="company", cascade="all, delete-orphan"
    )
    bookings = relationship(
        "Booking", back_populates="company", cascade="all, delete-orphan"
    )
    moderation_records = relationship(
        "ModerationRecord", back_populates="company", cascade="all, delete-orphan"
    )
    media = relationship(
        "Media", back_populates="company", cascade="all, delete-orphan"
    )
