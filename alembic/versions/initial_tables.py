...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "ratings_count", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "country", sa.String(), nullable=False, server_default=sa.text("'Россия'")
        ),
    ...
    op.create_index(
        op.f("ix_services_company_id"), "services", ["company_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(), nullable=False),
        sa.Column(
            "type", sa.String(), nullable=False, server_default=sa.text("'regular'")
        ),
        sa.Column(
            "start_date", sa.DateTime(), nullable=False, server_default=sa.text("now()")
        ),
    ...
    op.create_index(
        op.f("ix_schedules_company_id"), "schedules", ["company_id"], unique=False
    )
    op.create_index(
        op.f("ix_schedules_service_id"), "schedules", ["service_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "max_clients", sa.Integer(), nullable=False, server_default=sa.text("1")
        ),
        sa.Column(
            "booked_clients", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column("price", sa.Float(), nullable=True),
        sa.Column(
            "status", sa.String(), nullable=False, server_default=sa.text("'available'")
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_time_slots_schedule_id"), "time_slots", ["schedule_id"], unique=False
    )
    op.create_index(
        op.f("ix_time_slots_start_time"), "time_slots", ["start_time"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["time_slot_id"], ["time_slots.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(op.f("ix_bookings_id"), "bookings", ["id"], unique=False)
    op.create_index(
        op.f("ix_bookings_company_id"), "bookings", ["company_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(), nullable=False),
        sa.Column(
            "type", sa.String(), nullable=False, server_default=sa.text("'image'")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "total_revenue", sa.Float(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "total_bookings", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
        ...
        sa.Column(
            "completion_rate", sa.Float(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "cancellation_rate", sa.Float(), nullable=False, server_default=sa.text("0")
        ),
        ...
        sa.ForeignKeyConstraint(["company_id"], ["companies.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["most_popular_service_id"], ["services.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
