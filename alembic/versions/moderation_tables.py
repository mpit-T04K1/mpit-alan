...
def upgrade():
    ...
    op.create_index(
        op.f("ix_moderation_records_company_id"),
        "moderation_records",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_moderation_records_moderator_id"),
        "moderation_records",
        ["moderator_id"],
        unique=False,
    )
...
def downgrade():
    # Удаление таблицы
    op.drop_index(
        op.f("ix_moderation_records_moderator_id"), table_name="moderation_records"
    )
    op.drop_index(
        op.f("ix_moderation_records_company_id"), table_name="moderation_records"
    )
